...
title: "Mediumship, Gifts, Being a Channel of Love"
date: 2019-04-05
spirit_id: augustine
...
description: >
  Augustine reassures the circle that the messages received through their
  instrument are protected, and teaches how to discern the
  source of any channeled message: a Celestial spirit always speaks of love
  with Divine Love as the source of Truth, no message is flawless, and the
  soul ignited with the Father's Love recognizes Truth where the mind cannot.
  He counsels patience with the incremental journey to truth, and calls those
  gathered to release judgment of those whose approaches differ, to meet
  rejection with greater love, and to let self-acceptance make judgment of
  others impossible.
...
people: []
spirits: []
keywords: ["discernment", "mark of Truth", "kernel of truth", "false messages", "Celestial communication", "soul knowing", "test the spirits", "differences", "commonalities", "schisms", "rejection", "cry for love", "self-acceptance", "incremental", "patience", "unique soul"]
questions:
  - "How do I know if a channeled message is really from a Celestial spirit?"
  - "How can I tell true spiritual messages from false ones?"
  - "Are messages that come through mediums ever completely accurate?"
  - "What does it mean to test a message with your soul instead of your mind?"
  - "What does the Bible mean when it says test the spirits?"
  - "Why do sincere spiritual people disagree with each other?"
  - "How do I respond when someone rejects me for my spiritual beliefs?"
  - "How do I stop letting differences divide my spiritual community?"
...
notes: >
  Opens with a direct reassurance regarding the accuracy of messages received
  through this instrument.
essential_teachings: []
language: en
excerpt: >
  What does it matter, one soul’s opinion of you, when God loves you so?
door: >
