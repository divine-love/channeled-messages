...
people: []
spirits: []
keywords: ["sleep state", "soul travel", "silver cord", "spirit body", "dreams", "soul service", "spirit clinics", "guides", "intention", "soul condition"]
questions:
  - "What does the soul do while the body sleeps?"
  - "Can we travel in spirit and meet other souls while we sleep?"
  - "What is the silver cord and what limitations does it place on soul travel?"
  - "How can I become more aware of what happens to me in the sleep state?"
  - "Do our guides teach and communicate with us while we sleep?"
  - "Does setting an intention before sleep help us remember our spiritual experiences?"
  - "Can we meet with someone we are having a conflict with in the sleep state to resolve it?"
  - "Are there educational places or clinics in the spirit world we can visit during sleep?"
  - "Can people in different time zones meet in the spirit world during sleep?"
  - "Are we more aware of our soul condition when we are asleep than when we are awake?"
  - "Can the medium be used as a channel for celestial spirits during the sleep state?"
  - "Do we plan future events in our physical lives during the sleep state?"
related_messages: []
audio_url: ""
canonical_url: "https://divinelovesanctuary.com/sleep-state-q-a/"
notes: >
  Structured as a teaching followed by a live Q&A with those gathered. Questions are attributed to initials J, L, and M in the transcript; these have been preserved. John mentions that he tutors those gathered in their sleep state, and that the medium has been used as an instrument to speak through for celestial angels while in the sleep state without his conscious awareness.
essential_teachings: ["Core Teaching"]
language: en
excerpt: >
  There is not a day that is wasted, beloved souls. There is always some time spent in this blessed state and condition of service and learning and growing.
door: >
...
M: Would that be the same for a person who has a different time zone? One person is in the wake state, another person is in the sleep state, how can they meet?
