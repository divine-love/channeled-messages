...
description: >
  Augustine delivers a sober and wide-ranging teaching on the escalating imbalance
  of the Earth caused by humanity's accumulated lack of love, warning that the fires,
  floods, and upheavals visible in the world merely foreshadow what is coming. He
  assures the circle that God has a vast plan for the salvation of mankind already in
  motion, that those who have nourished their souls in Divine Love will be protected
  and will lead others through the transition, and that prayer with faith and joy is
  the single most important action each soul can take.
...
people: []
spirits: []
keywords: ["earth changes", "fires", "floods", "imbalance", "humanity", "free will", "God's plan", "salvation", "prayer", "faith", "joy", "Divine Love", "darkness", "light", "Celestial Heavens", "natural love", "harmony", "momentum", "prophecy"]
questions:
  - "Why are there so many natural disasters and catastrophes in the world?"
  - "Is climate change a spiritual problem as well as a physical one?"
  - "What does God plan to do about the state of the world?"
  - "How do I prepare spiritually for the changes coming to the world?"
  - "Why should I pray with joy rather than fear?"
  - "Will the world be healed?"
  - "What happens to people who die in earth changes and disasters?"
  - "How do I stay strong in faith when the world seems to be falling apart?"
  - "What role does prayer play in healing the world?"
  - "Why has humanity's free will led to such destruction?"
  - "How does living close to God protect me in difficult times?"
  - "What does it mean that none are condemned to darkness?"
related_messages:
  - 2015-08-17-af-jesus
  - 2017-09-13-af-keea-atta-kem
  - 2018-08-13-af-seretta-kem
audio_url: ""
...
door: Pray with faith and joy. For it is in this opening and joyful acknowledgment of God
  that the power required to heal your world will come
