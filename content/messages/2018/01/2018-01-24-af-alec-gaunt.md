...
description: >
  Alec Gaunt speaks to a group all standing on the threshold of change, assuring
  them that each soul is moving forward in its own timing, propelled by God's Love
  and Will. He encourages them to embrace the unexpected, to meet challenges with
  courage, and to trust that life's constant movement and change is itself the
  mechanism of soul growth and service.
...
people: []
spirits: []
keywords: ["threshold", "change", "new life", "timing", "transition", "soul faculties", "gifts", "courage", "bravery", "dynamic life", "surprises", "harmony", "channel of love", "scales", "wisdom"]
questions:
