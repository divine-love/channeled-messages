...
description: >
  Seretta Kem announces that a deep change is coming to the circles as gifts
  develop and doors open for wider service in the world. He calls each soul to
  prepare by deepening their connection with God, aligning mind and soul, and
  trusting that what has been years in preparation is now very close to fruition.
  He assures them that though the work will begin small and humble, it will grow
  as they persist in faith, and that each of them will find their unique role in
  the coming Dawn of Love.
