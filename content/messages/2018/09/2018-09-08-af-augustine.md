...
description: >
  Augustine responds to a question about the hierarchy of Heaven, confirming that
  non-human angelic forces created by God do exist beyond the Celestial Angels,
  assigned to oversee the workings of creation rather than the welfare of individual
  souls. He teaches that such deeper truths cannot be comprehended without the soul
  faculties opened by Divine Love, and gently redirects the circle toward simplicity,
  urging them to focus on their souls, their relationship with God, and the truths
  they are currently able to absorb.
primary_subjects: "Interdimensional & Spirit Communication"
secondary_subjects:
  - "Soul Awakening"
  - "Discernment & Truth-Seeking"
  - "God's Nature & Essence"
  - "Spirit Guides & Angels"
people: []
spirits: []
keywords: ["hierarchy of heaven", "angels", "non-human angels", "angelic forces", "Celestial Angels", "creation", "soul faculties", "truth incremental", "simplicity", "soul growth", "comprehension", "universe", "curiosity of mind", "elements of creation", "soul perception"]
questions:
  - "Are there different types of angels with different roles?"
  - "Do non-human angelic beings exist in God's creation?"
  - "What is the hierarchy of Heaven?"
  - "Why does God withhold certain truths until we are ready to receive them?"
  - "How does soul growth open our capacity to understand deeper truths?"
  - "What is the difference between Celestial Angels and other angelic forces?"
  - "How do I avoid overcomplicating my spiritual understanding?"
  - "What does the Bible say about angels and their roles in creation?"
  - "Why is simplicity so important on the spiritual path?"
  - "How do I know which truths I am ready to receive at my current level of growth?"
  - "What does it mean that truth comes incrementally in accordance with soul growth?"
  - "What does it mean that the mind's perception is a pale shadow of soul perception?"
related_messages:
...
series: []
door: Simplicity, my beloveds, simplicity is the key. Do not overtax yourselves with mindful considerations that do not lead to greater understanding
