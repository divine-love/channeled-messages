...
description: >
  Augustine challenges the circle to move beyond meekness and speak the truth
  plainly, simply, and powerfully, teaching that silence in the presence of error
  is an acceptance of error. He draws on the example of Jesus as one who could
  not compromise the truth despite angry opposition, and calls those gathered to
...
door: Silence in the presence of error is an acceptance of error
