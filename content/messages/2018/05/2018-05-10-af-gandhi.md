---
message_id: 2018-05-10-af-gandhi
title: "Change Comes One Soul at a Time"
date: 2018-05-10
spirit_id: gandhi
spirit_name: "Mahatma Gandhi"
medium: Al Fike
location:
  city: Gibsons
  region: BC
...
description: >
  Gandhi responds to the group's contemplation of the world's darkness and
  inequities, teaching that true change in the world begins with the individual
  soul and its reconciliation with God. He draws on his own Earth life, speaking
  of how one step led to another as he followed God's guidance, and urges those
  gathered not to be overwhelmed by the complexity of the world's problems but
  to trust that their awakening souls will reveal the role they must play.
...
people: []
spirits: []
keywords: ["India", "change", "one step at a time", "inequity", "darkness", "awakening", "active agent", "chain of light", "fulfillment", "faith", "purpose", "soul redeemed", "complexity", "world conditions"]
questions:
  - "How do I make a difference in a world with so many overwhelming problems?"
  - "Why is there so much suffering in the world if God loves us?"
  - "How did Gandhi change the world and what can I learn from his example?"
  - "Do I have to fix the world's problems or just live well in my own corner?"
  - "How does my inner spiritual growth affect the world around me?"
  - "Is it naive to think one person can make a difference?"
  - "How do I know what role I am meant to play in God's plan for the world?"
  - "What does it mean to be an active agent of change rather than a passive observer?"
  - "How do I stay hopeful when the world feels so dark and broken?"
  - "Did Gandhi reach the Celestial Heavens after he died?"
  - "How do I pray for a suffering country or people in a way that actually helps?"
related_messages:
  - 2016-04-05-af-gandhi
  - 2016-09-02-af-confucius
  - 2017-09-13-af-keea-atta-kem
  - 2018-03-26-af-james
audio_url: ""
canonical_url: "https://divinelovesanctuary.com/change-comes-one-soul-at-a-time/"
notes: >
  Gandhi speaks in the first person about his Earth life, his passing into spirit,
  and his ongoing growth in the Light of God's Love. He confirms that on passing
  his joy and sense of fulfillment overflowed and his rewards were great. The
  group had been contemplating the conditions of India and the world's inequities
  before this message was given.
essential_teachings: ["Core Teaching", "Spirit Biography"]
language: en
excerpt: >
  Did I not help to change the conditions of that place? One little man in my
  world, with determination, with faith, with wisdom affected the conditions and
  the pain of many and brought a measure of Light. This is all you can do, my
  friends.
collections: ["Awakening Humanity", "Letters from History"]
door: >
  You look at all the dilemmas of this world and throw up your arms. But it is your awakened soul that will find the role you must play. One step at a time
