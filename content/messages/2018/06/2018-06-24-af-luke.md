...
description: >
  Luke responds to a question from one in the circle, delivering a searching
  and compassionate teaching on judgment, humility, and the courage required
  for radical self-honesty. He teaches that when we perceive error in another
  and respond with judgment rather than compassion, we are falling into the
  mind's patterns of superiority - and that the path forward requires deep
  honesty about our own conditions, the willingness to bare our hearts to one
  another, and trust that God's Love will heal everything we are willing to
  bring to Him.
...
people: []
spirits: []
keywords: ["judgment", "compassion", "humility", "superiority", "rejection", "fear", "self-disclosure", "integrity", "dark patterns", "vulnerability", "forgiveness", "mirror", "liberation", "stasis", "direct voice"]
questions:
  - "Why do I keep judging people even when I know I shouldn't?"
  - "What did Jesus mean when he said judge not lest ye be judged?"
  - "What is the beam in my own eye that I can't see?"
  - "How do I love someone whose behaviour I find wrong or harmful?"
  - "Why do I feel superior to others when I see their faults?"
  - "How do I forgive someone who has genuinely hurt me?"
  - "Why is self-honesty so frightening?"
  - "What does it mean to bare my heart and soul to another person?"
  - "How do I know if my perception of someone's fault is really a reflection of my own?"
  - "Am I strong enough to look at myself honestly without falling apart?"
  - "Why does being in a spiritual community sometimes make me more judgmental rather than less?"
  - "What does the Bible mean when it says love does not seek its own?"
related_messages:
  - 2017-06-15-af-augustine
  - 2016-03-30-af-augustine
  - 2018-04-03-af-luke
audio_url: ""
canonical_url: "https://divinelovesanctuary.com/seek-humility-and-compassion-for-self-and-others/"
notes: >
  Luke opens by addressing "dear daughter," responding to questions she has
  asked. The message speaks directly to the circle of seven and their
  interpersonal dynamics.
significance: ["Key Teaching"]
language: en
excerpt: >
  When another hurts you, the most powerful response is forgiveness. When you
  disagree with another, be accepting and loving. When you have an intense
  reaction to another's behaviour, realize that within you lies the same
  condition - and their gift to you is to bring you to that awareness.
series: ["Mind & Soul", "Healing Path"]
door: When another hurts you, the most powerful response is forgiveness. When you react intensely to another's behaviour, that condition lives in you too - and their gift is to show you
