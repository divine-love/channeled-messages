---
message_id: 2018-11-21-af-gandhi
...
description: >
  Gandhi encourages a group of souls on a prayer mission to remain open to
  God's guidance for travel and service, reminding them that Jesus himself
  travelled widely in his ministry. He assures them that their light grows
  stronger with each day and that the time will come when their humble,
  loving presence will turn heads and bring acknowledgement.
...
people: []
spirits: []
keywords: ["travel", "ministry", "guidance", "channel of love", "humility", "faith", "light", "service"]
questions:
  - "How do I know where God is guiding me to serve?"
  - "Why doesn't God give me more detail about what is coming?"
  - "How do I stay faithful when I can't see the plan?"
  - "Is it normal to feel that few people are listening to my message?"
  - "How do I become a clearer channel of God's Love?"
  - "What does it mean to test my motivations each day?"
  - "How did Jesus approach his ministry and what can I learn from that?"
  - "How do I balance eagerness to serve with patience and humility?"
related_messages: []
audio_url: ""
canonical_url: "https://divinelovesanctuary.com/encouragement-to-continue-with-plans/"
notes: >
  Message addressed to a small group of souls on a prayer mission in Sydney.
  Gandhi refers to their upcoming travel plans and encourages flexibility
  in following God's guidance.
essential_teachings: []
language: en
excerpt: >
  Know that Mahatma Gandhi is your brother. God bless you.
door: >
  You do not need to know the whole plan; you only need to stay close enough
  to God to hear the next step.
collections:
  - "Service & Mission"
