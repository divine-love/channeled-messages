...
date: 2015-06-15
spirit_name: Joseph Smith
spirit_id: joseph-smith
medium: Al Fike
location:
  city: Gibsons
  region: BC
...
description: >
  ...
  has since become too infected by the will of man. He reflects on how organised
  religion in general allows human ambition and error to usurp God's Will, and
  teaches that a true church is simply a community of souls seeking Light and
  fellowship together. He calls all who seek truth to walk the path of Divine
  Love and be living examples of that Love from within whatever community they
  find themselves.
...
people: []
spirits: []
keywords: ["Joseph Smith", "Mormon Church", "organised religion", "human condition", "will of man", "falsehoods", "Divine Love", "true church", "fellowship", "error", "truth", "angels", "Celestial Heavens", "harbingers", "power", "religious institution"]
questions:
  - "Can the founder of a religion be in the Celestial Heavens even if his church went wrong?"
  - "Why do organised religions drift away from the original truth they were founded on?"
  - "Can I follow God's Truth while remaining within an organised religion?"
  - "What is a true church in God's eyes?"
  - "How does the will of man usurp the Will of God in religious institutions?"
  - "How do I challenge error in my faith community with love and integrity?"
  - "Did angels really support the founding of major world religions?"
  - "What does it mean to be a harbinger of Divine Love within an existing church?"
  - "How does the desire for power corrupt religious institutions?"
  - "What does the Bible mean when it says where two or three are gathered in my name?"
  - "How do I find or create true spiritual fellowship outside of institutional religion?"
  - "Can souls from any religious background reach the Celestial Heavens through Divine Love?"
related_messages:
  - 2016-04-12-af-moses
...
door: The will of man usurps the Will of God. The imaginings and ideas of men create falsehoods and misinterpretations of the laws and Love of God
