---
message_id: 2016-05-30-af-augustine
...
description: >
  Augustine calls his students to redouble their prayers and choose loving
  thoughts and engagements as a way of counteracting the dark conditions of
  the world and healing what they have inherited and accumulated. He tells
  them a law is enacted when they earnestly long for the Father's Love,
  drawing the angels close and pushing back the darkness, and reminds them
  that progress comes in fits and starts, each choice for Light making the
  next one easier.
primary_subjects: "Darkness vs Light"
secondary_subjects:
  - "Prayer & Devotion"
  - "Law of Activation"
...
people: []
spirits: []
keywords: ["staying in the Light", "redoubling prayer", "dark influences", "thoughts", "discipline", "respite", "angels drawn close", "increments", "old patterns", "choice for Light", "counteracting conditions"]
questions:
  - "How do I stay spiritually positive in a dark world?"
  - "Why do I keep slipping back into old patterns?"
  - "Does prayer actually bring the angels closer?"
  - "How do I control my thoughts when they turn negative?"
  - "Why is spiritual progress so uneven?"
  - "What good does praying with other people do?"
  - "How do I stop absorbing the negativity around me?"
  - "Does every good choice make the next one easier?"
related_messages:
  - 2016-02-29-af-luke
audio_url: ""
canonical_url: ""
...
language: en
excerpt: >
  With each choice for Light you reinforce this Path, you make it easier for
  you to make this choice.
door: >
  Every choice for Light lays track for the next one. That is why it gets
  easier, and why it never feels like it should.
