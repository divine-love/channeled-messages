...
description: >
  John the Beloved urges the circle not to falter, doubt, or worry for their
  material well-being, but to seek God's Will in every breath, promising that in
  this search the door to their unique purpose will open. He teaches that each
  soul has been called to be an instrument for change and a channel of Love as
  the world approaches times of deep transition, and that fulfilling this
...
spirits:
  - jesus
keywords: ["do not falter", "purpose", "unique gifts", "God's will", "instrument for change", "channel of love", "world transition", "discernment", "soul faculties", "material worry", "guidance", "angels", "fulfilment", "salvation of mankind"]
questions:
  - "How do I discover my unique purpose in life?"
  - "How do I stop worrying about money while following a spiritual path?"
  - "How do I seek and discern God's Will for my life?"
  - "Why do so few people ever realize their true purpose?"
  - "What does it mean to be an instrument for change in the world?"
  - "How do I keep faith when I am tempted to doubt or falter?"
  - "How do I put aside my own will and follow God's guidance instead?"
  - "Where does the deepest sense of fulfilment come from?"
related_messages: []
audio_url: ""
canonical_url: ""
language: en
excerpt: >
  Each of you has a unique and special purpose to fulfill in this world, and
  each of you have been called to be an instrument for change, a channel of Love.
door: >
  Almost no one finds the door to their purpose while on Earth. It is standing right in front of you, and it opens from the inside.
