---
message_id: 2016-07-04-af-jesus
...
description: >
  Jesus answers a question raised on a walk in the forest about how guidance is
  given and to whom, explaining that a message received through a medium is
  coloured by that instrument and gives an approximation of what was intended,
  since complete truth cannot pass through a soul not yet cleansed to the level
  of a celestial angel. He assures them that what has come through this
  instrument carries the quality of truth, calls them to meet criticism with
  love rather than return it, and tells them the calm waters they long for exist
  nowhere in this world except in the place between the soul and God.
...
people: []
spirits: []
keywords: ["guidance", "channelled messages", "approximation of truth", "no perfect mediums", "criticism", "ridicule", "tolerance", "patience", "inner peace", "calm centre", "choppy waters", "thought conditions", "gifts coming to fruition", "beacon of light", "protection"]
questions:
  - "How accurate are channelled messages?"
  - "Why does a spirit message sound like the medium who received it?"
  - "Can I trust a message that came through a medium?"
  - "How do I handle people who criticise my spiritual path?"
  - "What do I do when someone's negativity gets under my skin?"
  - "Why does my life never feel calm no matter what I do?"
  - "How do I find peace when the world feels so chaotic?"
  - "Was Jesus ridiculed and criticised when he walked the Earth?"
  - "Is it wrong to be critical of other people's spiritual work?"
  - "How do I stay steady when others push back on my gifts?"
related_messages:
...
language: en
excerpt: >
  You seek to sail your ship upon calm waters and I say these waters are not
  calm they are choppy indeed.
door: >
  There are no calm waters in this world. The stillness you are looking for
  exists only in the place between you and God.
