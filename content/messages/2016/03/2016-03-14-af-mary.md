...
description: >
  Mary speaks of the children of the world as its future and stewards, grieving
  that so many, even amid plenty, are lost and unloved, caught in distraction and
  unable to know themselves. She affirms that some are born now with great
  potential to lead the world to Light, calls the circle to pray for them, and
  teaches the simple truth that every soul is made in love, to love, for love,
  and is here to discover itself, to love, and to know God. The great work is to
  teach these truths and help tear away the layers that bury the soul, beginning
  with the children whose hearts remain open.
primary_subjects: "Humanity's Spiritual Condition & Awakening"
secondary_subjects:
...
people: []
spirits: []
keywords: ["children", "future", "stewards", "the lost", "distraction", "purpose of life", "made in love", "self-discovery", "teaching", "awakening", "layers", "leaders", "gifted souls", "let the children come"]
questions:
...
language: en
excerpt: >
  Every soul is made in love, to love, for love, and every breath that every
  soul takes must be in this flow and grace.
door: >
