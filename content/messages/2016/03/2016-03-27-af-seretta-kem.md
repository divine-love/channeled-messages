...
description: >
  Seretta Kem teaches the dynamics of mediumship, naming the laws that come into play and explaining how a truth held wordlessly in the soul is narrowed and distorted as it passes up into the material mind, so that no medium is perfect and every message is incomplete. He calls each soul to deepen the channel between soul and mind through prayer, to send love to those who speak, and to recognise that all souls, not only mediums, are continually influenced by spirit.
...
people: []
spirits: []
keywords: ["mediumship", "rapport", "spirit communication", "soul to mind", "distortion", "no perfect mediums", "Law of Love", "encrustations", "material mind", "send love to the medium", "spirit influence", "one truth at a time", "redemption", "control"]
questions:
  - "How does spirit communication through a medium actually work?"
  - "Why are channelled messages sometimes incomplete or distorted?"
  - "Are there any perfect or completely accurate mediums?"
  - "Why does what my soul knows get lost on its way into my mind?"
  - "How do I deepen the connection between my soul and my conscious mind?"
  - "What should I do when part of a spiritual message does not resonate with me?"
  - "Why is it important to send love to the person delivering a message?"
  - "Does spirit influence everyone, or only those with mediumistic gifts?"
  - "How do I attract higher influences and avoid negative ones?"
...
canonical_url: ""
notes: >
  Not publicly posted online. Seretta Kem opens by noting that this message fulfils a promise to return and reiterate his teaching on mediumship.
essential_teachings: ["Core Teaching"]
language: en
excerpt: >
  There are no perfect mediums in this world. Each one influences what is brought through.
door: >
