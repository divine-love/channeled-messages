DRAFT, proposed practice file. Format is my best guess at the content/practices/ convention; I do not have an existing practice file in hand to match against, so the front-matter schema below is inferred from the message schema and should be checked against prayer-for-divine-love-dlsf.md and its siblings before use. Filename is a proposal: prayer-keea-atta-kem-fill-my-soul.md.
